...
export default function PetaBlok() {
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      ...
      // Filter by 'blok' param (specific course code)
      if (blok && blok !== 'all' && blok !== 'NONBLOK' && !isAntara) {
      ...
      if (!mulaiTimes.length) {
          [...allPbl, ...allJurnal, ...allKuliahBesar].forEach(item => {
  ...
  }, [blok, isAntara, isGanjil, isGenap, tipe]);
