...
const UPTJurnal: React.FC = () => {
  ...
  return (
    <RekapIKDBase
      title="Rekap IKD - UPT Jurnal"
      description="Rekap Indikator Kinerja Dosen untuk UPT Jurnal"
    >
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-4">
          <div>
            <h2 className="text-xl font-bold text-gray-800 dark:text-white/90 mb-1">
              Tabel Rekap IKD - UPT Jurnal
            </h2>
            <p className="text-sm text-gray-600 dark:text-gray-400">
              Kelola rekap IKD untuk unit kerja UPT Jurnal
            </p>
          </div>
        </div>
              ...
              >
                ...
                <div>
                  ...
                  <p className="mb-6 text-sm text-orange-600 dark:text-orange-400 font-medium">
                    Setelah menyimpan, Anda tidak akan bisa mengupload file lagi untuk kegiatan ini.
                  </p>
                  <div className="flex justify-end gap-2 pt-2">
                    <button
                      onClick={() => {
