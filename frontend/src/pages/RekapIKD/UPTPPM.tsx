...
const UPTPPM: React.FC = () => {
  ...
  return (
    <RekapIKDBase
      title="Rekap IKD - UPT PPM"
      description="Rekap Indikator Kinerja Dosen untuk UPT PPM"
    >
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-4">
          <div>
            <h2 className="text-xl font-bold text-gray-800 dark:text-white/90 mb-1">
              Tabel Rekap IKD - UPT PPM
            </h2>
            <p className="text-sm text-gray-600 dark:text-gray-400">
              Kelola rekap IKD untuk unit kerja UPT PPM
            </p>
          </div>
        </div>
