...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        if (!Schema::hasColumn('jadwal_pbl', 'penilaian_submitted')) {
        ...
        if (!Schema::hasColumn('jadwal_jurnal_reading', 'penilaian_submitted')) {
        ...
        if (!Schema::hasColumn('jadwal_praktikum', 'penilaian_submitted')) {
        ...
        if (!Schema::hasColumn('jadwal_kuliah_besar', 'penilaian_submitted')) {
        ...
        if (!Schema::hasColumn('jadwal_non_blok_non_csr', 'penilaian_submitted')) {
