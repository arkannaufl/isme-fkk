...
return new class extends Migration
{
    ...
    {
        Schema::create('jadwal_seminar_pleno', function (Blueprint $table) {
            $table->id();
            ...
            $table->unsignedBigInteger('kelompok_besar_id')->nullable();
    ...
    {
        Schema::dropIfExists('jadwal_seminar_pleno');
    }
};
