...
class PenilaianSidangSkripsiController extends Controller
{
    /**
    ...
    public function getByJadwal($jadwalId)
    {
        ...
        $grouped = $penilaian->groupBy('mahasiswa_id')->map(function ($items, $mahasiswaId) {
            ...
            return [
                ...
                'nilai_huruf' => $nilaiAkhirMahasiswa ? PenilaianSidangSkripsi::konversiNilaiHuruf($nilaiAkhirMahasiswa) : null,
            ];
        })->values();
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'peran_penguji' => 'required|in:pembimbing,penguji_1,penguji_2',
        ...
        $penilaian = PenilaianSidangSkripsi::updateOrCreate(
            [
